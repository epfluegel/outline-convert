...
\section{Ethical and Legal Aspects of Security \#e \#ethics \#eyo-style:Section \#h}
\begin{frame}{Learning Objectives -- Legal and Ethical Issues \#slide \#CI7130\_Rev \#legal}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}{Motivation \#slide \#legal \#CI7130}
\begin{itemize}
...
\end{itemize}
\end{frame}
\subsection{Legal Aspects in Computer Security \#h \#legal \#CI7130 \#eyo-style:Subsection}
\subsection{Computer and Cybercrime \#h \#legal \#CI7130 \#eyo-style:Subsection}
\begin{frame}{Computer Crime is a Separate Category \#slide \#legal \#CI7130}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}{Challenges for Fighting Computer Crime \#slide \#legal \#CI7130}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}{Definition of Computer Crime \#slide \#legal \#CI7130}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}{Mini-Exercise \#slide}
\begin{itemize}
...
\end{itemize}
\end{frame}
\subsection{Legal Computer Security Controls \#h \#legal \#CI7130 \#eyo-style:Subsection}
\begin{frame}{[COMPLETE] Threats to Critical Assets \#slide \#legal \#CI7130}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}{[COMPLETE] Threats to Critical Assets (cont.) \#slide \#legal \#CI7130}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}{[COMPLETE] Applying Traditional Legal Protection to Computer Assets \#slide \#legal \#CI7130}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}{[COMPLETE] Trade Secrets \#slide \#legal \#CI7130}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}{[COMPLETE] Trademarks \#slide \#legal \#CI7130}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}{[COMPLETE] Trade Secrets and Trademarks \#slide}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}{[COMPLETE] Mini-Exercise -- Which Legal Control Example? \#slide}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}{[COMPLETE] Copyrights \#slide \#legal \#CI7130}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}{[COMPLETE] Software Licensing \#slide \#legal \#CI7130}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}{[COMPLETE] Open Source Licenses \#slide \#legal \#CI7130}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}{[COMPLETE] Patents \#slide \#legal \#CI7130}
\begin{itemize}
        \item Traditional purpose:
        \begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}{[COMPLETE] Controls Protecting Privacy \#slide \#privacy \#CI7130}
\begin{itemize}
        \item Legal
        \begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}{[COMPLETE] Mini-Exercise: Open Source Code \#slide \#CI7130}
\begin{itemize}
...
\end{itemize}
\end{frame}
\subsection{Ethical Issues in Computer Security \#h \#ethics \#CI7130 \#eyo-style:Subsection \#new}
\begin{frame}{Definition of Ethical System \#slide \#ethics \#CI7130}
\begin{itemize}
      \item Ethical System
      \begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}{Vulnerability Disclosure Dilemma \#slide \#ethics \#CI7130}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}{Discussion of Dilemma \#slide \#ethics \#CI7130}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}{Grey-Hat Hacking \#slide \#ethics \#CI7130}
\begin{itemize}
      \item 
...
\end{itemize}
\end{frame}
\begin{frame}{The Ethics of Grey-Hat Hacking \#slide \#ethics \#CI7130}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}{Strategic Security Games \#slide}
\end{frame}
\begin{frame}{Interacting with a Grey-Hat Hacker \#slide}
\end{frame}
\begin{frame}{The Bimatrix Grey-Hat Hacker Game \#slide}
\end{frame}
\begin{frame}{Grey-Hat Hacker Game: Strategic Normal Form \#slide}
\end{frame}
\begin{frame}{Dilemma Discussion \#slide \#ethics \#CI7130}
\begin{itemize}
